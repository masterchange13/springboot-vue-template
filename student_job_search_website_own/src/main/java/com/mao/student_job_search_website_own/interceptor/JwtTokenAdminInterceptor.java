package com.mao.student_job_search_website_own.interceptor;

import com.mao.student_job_search_website_own.constant.JwtClaimsConstant;
import com.mao.student_job_search_website_own.context.BaseContext;
...
public class JwtTokenAdminInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        //1、从请求头中获取令牌
        log.info("jwt校验开始:{}", request.getRequestURI());
